...
class TestPlace(unittest.TestCase):
    ...
    def test_attributes(self):
        ...
        self.assertEqual(place.nombre_chambres, 0)
        self.assertEqual(place.nombre_salles_de_bain, 0)
        self.assertEqual(place.max_invités, 0)
        self.assertEqual(place.prix_par_nuit, 0)
